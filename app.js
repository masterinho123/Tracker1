...
const SchoolGradesView = ({ schoolData, setSchoolData, isLight, openSyncSettings, t, language }) => {
                    ...
                    <div className="relative">
                        ...
                        {showLangMenu && (
                            <>
                                ...
                                />
                                <div className={`absolute bottom-0 left-full ml-2 z-50 py-2 rounded-xl shadow-xl border ${isLight ? 'bg-white border-slate-200' : 'bg-[#1e293b] border-slate-700'} min-w-[140px]`}>
                                    <button 
