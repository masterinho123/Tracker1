...
const WeeklyBarsSmall = ({ weeks = [], isLight }) => {
    ...
    return (
        <div ref={containerRef} className="w-full h-full flex items-end justify-between px-3 relative">
            {weeks.map((v, i) => {
                ...
                return (
                    ...
                    >
                        ...
                        <div className={`rounded-md flex items-end overflow-hidden transition-all duration-300 ${isLight ? 'bg-slate-100' : 'bg-slate-800/50'} ${hoveredIdx === i ? 'ring-2 ring-blue-500/20 scale-105' : ''}`} style={{ width: `${barW}px`, height: '140px' }}>
                            <div 
