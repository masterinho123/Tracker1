...
const SchoolGradesView = ({ schoolData, setSchoolData, isLight }) => {
    ...
    const getGradeColor = (value, max = 10, isLight = false) => {
        ...
        if (percent < 9) return isLight ? 'text-green-600 bg-green-100 border-green-200' : 'text-green-400 bg-green-400/10 border-green-400/20 shadow-green-900/10';
        if (percent < 9.5) return isLight ? 'text-cyan-600 bg-cyan-100 border-cyan-200' : 'text-cyan-400 bg-cyan-400/10 border-cyan-400/20 shadow-cyan-900/10';
    ...
    const getGradeBarColor = (value, max = 10, isLight = false) => {
        ...
        if (percent < 9) return isLight ? 'from-green-600 to-green-400' : 'from-green-600 to-green-400';
        if (percent < 9.5) return isLight ? 'from-cyan-600 to-cyan-400' : 'from-cyan-600 to-cyan-400';
