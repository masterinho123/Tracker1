            ...
            {weeks.map((v, i) => {
                ...
                return (
                    <div key={i} className="flex flex-col items-center">
                        <div className={`rounded-md flex items-end overflow-hidden ${isLight ? 'bg-slate-100' : 'bg-slate-800/50'}`} style={{ width: `${barW}px`, height: '140px' }}>
                            <div className="bg-blue-500 w-full transition-all duration-500" style={{ height: `${h}px` }}></div>
                        </div>
