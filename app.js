                    ...
                    <div className={`h-48 border-t ${isLight ? 'border-slate-200 bg-white' : 'border-[#1f2937] bg-[#0f172a]'} relative transition-colors duration-300`}>
                        {ResponsiveContainer && AreaChart && Area ? (
                            ...
                            <SimpleAreaChart 
                                ...
                                datasets={[
                                    { values: chartData.map(d => d.mood), color: "#ec4899", label: t.mood, id: "mood" },
                                    { values: chartData.map(d => d.motivation), color: "#3b82f6", label: t.motivation, id: "mot" }
                                ]}
                                isLight={isLight}
                            />
                        )}
                ...
                <div className={`${isLight ? 'bg-white border-slate-200 shadow-sm' : 'bg-[#0f172a] border-[#1f2937] shadow-2xl'} border rounded-3xl overflow-hidden transition-colors duration-300`}>
                    ...
                    <div className="grid grid-cols-7">
                        {days.map((date, i) => {
                            ...
                            // Calcoliamo la data odierna rispettando il fuso orario locale
                            const now = new Date();
                ...
                <div className="mt-auto flex flex-col gap-4 items-center">
                    ...
                    <div className="relative">
                        <button 
                            ...
                            className={`p-2.5 rounded-xl transition-all duration-200 flex items-center justify-center ${isLight ? 'text-slate-500 hover:bg-slate-100' : 'text-slate-400 hover:bg-slate-800'} ${showLangMenu ? (isLight ? 'bg-slate-100' : 'bg-slate-800') : ''}`}
                        ...
                        {showLangMenu && (
                            <>
                                ...
                                />
                                <div className={`absolute bottom-0 left-full ml-2 z-50 py-2 rounded-xl shadow-xl border ${isLight ? 'bg-white border-slate-200' : 'bg-[#1e293b] border-slate-700'} min-w-[120px]`}>
                                    <button 
                                    ...
                                    >
                                        <svg className="w-5 h-3.5 rounded-sm" viewBox="0 0 3 2">
                                            <rect width="1" height="2" fill="#009246"/>
                                            <rect x="1" width="1" height="2" fill="#fff"/>
                                            <rect x="2" width="1" height="2" fill="#ce2b37"/>
                                        </svg>
