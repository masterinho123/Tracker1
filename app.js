...
const Header = ({ totalHabits, completedHabits, totalPossible, currentDate, onNext, onPrev, onNextYear, onPrevYear, onExport, onImportClick, syncCode, setSyncCode, syncWord, setSyncWord, syncStatus, syncError, apiBase, setApiBase, supabaseConfig, setSupabaseConfig, isLight, openSyncSettings }) => {
            ...
            <div className="flex items-center gap-4 flex-shrink-0">
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                    ...
                    >
                        ...
                        <div className={`text-[10px] ${isLight ? 'text-slate-600' : 'text-slate-300'} font-mono mr-2`}>
                            {syncCode || 'No Code'}
                        </div>
